  ...
  head: () => ({
    meta: [
      ...
      { title: "VIVA — Active Natural Care" },
      {
        name: "description",
        content:
          "VIVA Active Natural Care — apresentação digital da marca: produtos, natureza, ciência e propósito.",
      },
      { property: "og:title", content: "VIVA — Active Natural Care" },
      {
        property: "og:description",
        content: "Uma experiência de marca em rolagem contínua. VIVA Active Natural Care.",
      },
